...
| ID | Requirements                                                                                                                                          | Size | Effort (h) |
|----|-------------------------------------------------------------------------------------------------------------------------------------------------------| --- | --- |
| FA01 | Register and login with school email (via verif code on @htlstp.at)                                                                                 | M                                                                                                                                                       | 4 |
| FA02 | User account management (change password)                                                                                                           | S                                                                     | 1.5 |
| FA03 | Manage projects (create + update [upload har files + target url])                                                                                   | S-M                                                                   | 3 |
| FA04 | Ability to start website analysis and save the result or get old one (dns, tech stack fingerprinting, endpoints mapping, SSL/TLS certificate check) | L                                                                     | 10 |
| FA05 | 90% test coverage for backend logic and api endpoints (unit + integration)                                                                          | M                                                                                                                                                     | 3 |
| FA06 | Complete documentation (openAPI, er diagramm, how to start)                                                                                         | S-M                                                                                                                                                   | 3 |
